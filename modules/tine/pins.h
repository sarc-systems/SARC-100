...
// Audio
#define AUDIO_IN_A   2   // All-in A
#define AUDIO_IN_B   3   // All-in B
#define AUDIO_OUT_A  2   // Scan out A
#define AUDIO_OUT_B  3   // Scan out B

// Analog in (CV)
#define ANALOG_SCAN_A_CV           0   // Output scan A CV
#define ANALOG_SCAN_B_CV           3   // Output scan B CV
#define ANALOG_TUNE_CV             1   // F0 tune CV
#define ANALOG_DETUNE_CV           2   // Detune CV
#define ANALOG_NODE_COUPLING_A_CV  4   // Node Coupling A CV
#define ANALOG_NODE_COUPLING_B_CV  6   // Node Coupling B CV
#define ANALOG_XCOUPLE_AMOUNT_CV   5   // Cross-couple amount CV (total budget)

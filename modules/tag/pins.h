...
#define ANALOG_P1_SPEED_CV 0
#define ANALOG_P2_SPEED_CV 1
#define ANALOG_P3_SPEED_CV 2
#define ANALOG_DAMPING_CV  3

// Audio out — DC-coupled, r/θ pairs for each player
#define AUDIO_OUT_P1_R 2
#define AUDIO_OUT_P1_T 3
#define AUDIO_OUT_P2_R 4
#define AUDIO_OUT_P2_T 5
#define AUDIO_OUT_P3_R 6
#define AUDIO_OUT_P3_T 7

// Digital in
#define DIGITAL_RESET  0
#define DIGITAL_FREEZE 1

// Digital out — IT gates (level), triggers (single-sample)
#define DIGITAL_IT1      2
#define DIGITAL_IT2      3
#define DIGITAL_IT3      4
#define DIGITAL_TAG      5
#define DIGITAL_WALL1    6
#define DIGITAL_WALL2    7
#define DIGITAL_WALL3    8
#define DIGITAL_WALLANY  9
